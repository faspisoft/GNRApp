 ...
 const   FlatListHeader = () => {
        return (
            <View
                ...
                <Text style={{ fontSize: 13 / fontFactor, marginEnd: 10, alignSelf: "center", flex: 2, textAlign: 'center', color: "#000000" }}>LrNo</Text>
            </View>
        );
    }
    // render() {
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: '#009A22' }}>
                <View style={{ flex: 1, backgroundColor: "#eeeeee" }}>
                    <Header showBack={true} title={"DEF"} rightIcon={logout}  />
                        ...
                        renderItem={({ item, index }) =>
                            // <TouchableOpacity onPress={() => { navigation.navigate('DefDetails', { 'DefDetails': item.Id }) }}>
                                <View style={{ paddingTop: 10, paddingBottom: 10, width: '100%', backgroundColor: index % 2 == 0 ? "#ffffff" : "#99D9EA", flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <Text style={{ marginLeft: 10, alignSelf: "center", fontSize: 12 / fontFactor, flex: 1, color: "#000000" }}>{item.Lrno}</Text>
                                </View>
                            // </TouchableOpacity>
                        }
                    />
