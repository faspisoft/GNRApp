...
const UpdateDef=({navigation,route})=>{
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#eeeeee' }}>
                ...
                <ScrollView>
                    <View style={{ flex: 1, backgroundColor: "#eeeeee" }}>
                        ...
                        <Text style={{ color: "#b22222", alignSelf: "center", marginTop: 10, fontSize: 20, textDecorationLine: 'underline' }}>UPDATE DEF Details</Text>
                        ...
                        <View style={{ marginTop: 10 }}>
                            ...
                            <TextInput style={[styles.TextInputStyle]}   onChangeText={(num) => setQuantity(num)}/>
                        </View>
